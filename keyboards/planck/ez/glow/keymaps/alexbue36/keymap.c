...
[_BASE] = LAYOUT_ortho_4x12(
    ...
    XXXXXXX,      XXXXXXX,  XXXXXXX,  LT(LA_NAV, KC_TAB), LT(LA_SYM, KC_ESC),  XXXXXXX,  XXXXXXX,  LT(LA_NUM, KC_ENT),  LT(LA_NAV, KC_SPC),  XXXXXXX,  XXXXXXX,  XXXXXXX
),
...
[_NUM] = LAYOUT_ortho_4x12(
    KC_LBRC,   KC_7,      KC_8,      KC_9,     KC_RBRC,     XXXXXXX,  XXXXXXX,  _______,   _______,   _______,   _______,   _______,
    KC_SCLN,   KC_4,      KC_5,      KC_6,     KC_EQL,      XXXXXXX,  XXXXXXX,  _______,   KC_LSFT,   KC_LGUI,    KC_LALT   KC_LCTL,
    KC_BSLS,   KC_1,      KC_2,      KC_3,     KC_MINS,     XXXXXXX,  XXXXXXX,  _______,   _______,   _______,   _______,   _______,
    XXXXXXX,   XXXXXXX,   XXXXXXX,   KC_DOT,   KC_0,        XXXXXXX,  XXXXXXX,  _______,   _______,   XXXXXXX,   XXXXXXX,   XXXXXXX
),
